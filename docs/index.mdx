...
export const CallToAction = props => {
  return <div style={{ marginTop: "50px", marginBottom: "50px", padding: "32px", border: "1px solid gray", borderRadius: "16px", backgroundImage: "url(/assets/graphics/robot_tree_farm_lighter.png)", display: "flex", flexDirection: "column", justifyContent: "center"}}>
      <h3>{ props.heading }</h3>
      { props.text }
