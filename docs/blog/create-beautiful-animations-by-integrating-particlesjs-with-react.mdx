---
title: Create Beautiful Animations by Integrating Particles.js With React
description: Have you ever wondered how some programmers are able to produce beautiful backdrop animations like fireworks, confetti, or a night sky with twinkling stars? I initially assumed it was just a video playing in the background, or that some rockstar developer had spent hours creating it manually. However, after doing a lot of research, I discovered a great package for creating nice background animations without the need for any complicated code. The JavaScript plugin used to make 2D animations like the ones mentioned above is called Particles.js.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/create-beautiful-animations-by-integrating-particlesjs-with-react" />
...
<GridFlexRow><Tag>react</Tag> <Tag>animations</Tag></GridFlexRow>
