...
description: In this blog post, we will build a React application through which we can draw interactive shapes with the help of the Canvas API. We’ll also learn about Canvas HTML elements, the Canvas API, and drawing different shapes with mouse interactions.
---

<link rel="canonical" href="https://code.pieces.app/blog/draw-interactive-shapes-react-canvas-api" />
...
<GridFlexRow><Tag>react</Tag> <Tag>canvas</Tag></GridFlexRow>
