...
description: SolidJS is a JavaScript declarative User Interface (UI) library for web applications. It is comparable to other JavaScript frameworks like Svelte, React, and Vue. Ryan Carniato developed SolidJS, which was released as open-source in 2018.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/getting-started-with-solidjs" />
...
<GridFlexRow><Tag>solidjs</Tag> <Tag>javascript</Tag></GridFlexRow>
