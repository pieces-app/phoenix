...
description: This is a step-by-step tutorial that will walk you through the process of retrieving data from an OpenSea API using Flutter and GetX.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/flutter-getx-fetching-data-from-opensea-api" />
...
<GridFlexRow><Tag>api</Tag> <Tag>flutter</Tag></GridFlexRow>
...
![](https://uploads-ssl.webflow.com/embed/Hjv0n_Qp9lQ?feature=oembed&list=PLrTDw7ICfHFkvOFW_AERUTUbpmIPFccjS&index=3)

**Full Source Code:**
<a href="https://bit.ly/3NkrvkZ" target="_blank" rel="noopener noreferrer">https://bit.ly/3NkrvkZ</a>

### Bonus Tip!
If you want to be more productive and grab the codes easily from any website, [try Pieces](https://code.pieces.app/install). It allows you to save snippets in one-click from the web or your editor, and it auto-saves your frequently used code. Pieces also recommends snippets with Framework standards, saves snippets from screenshots, and much more.