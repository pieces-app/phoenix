---
title: Getting Started with VueJS | Introduction to Vue 3
description: Vue 3 is a JavaScript framework for building user interfaces. It builds on top of standard HTML, CSS and JavaScript, and provides a declarative and component-based programming model that helps you efficiently develop user interfaces that can be either simple or complex.
---

<link rel="canonical" href="https://code.pieces.app/blog/getting-started-with-vuejs-introduction-to-vue-3" />
...
<GridFlexRow><Tag>vue</Tag> <Tag>cli</Tag></GridFlexRow>
...
<a href="https://vuejs.org/guide/extras/composition-api-faq.html" target="_blank" rel="noopener noreferrer">Composition API</a> is pre-installed in Vue 3 and is ready to use right out of the box without any further configuration.
...
In **Vue2**, we define local filters in a component’s options:
...
- For quick set up of your<a href="https://vuejs.org/guide/quick-start.html" target="_blank" rel="noopener noreferrer"> Vue 3 Project</a> that doesn’t require the Vue CLI:
...
![](https://uploads-ssl.webflow.com/6143afec68f555387049efb3/6349a9406c27c23973b38889_image5_4e128af4e645e169f9696d78dc907541_800.png)
