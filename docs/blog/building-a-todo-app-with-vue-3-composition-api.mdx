...
description: The Composition API was a significant advancement in Vue 3. It consists of a group of APIs that let users use Vue's parts by importing functions rather than expressing options as they would when using the Options API.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/building-a-todo-app-with-vue-3-composition-api" />
