...
<a href="https://code.pieces.app/blog/npm-vs-yarn-how-do-they-compare" target="_blank" rel="noopener noreferrer">Install the dependencies with yarn</a> by first moving them into the newly created folder:
