...
<GridFlexRow><Tag>interface</Tag> <Tag>go</Tag></GridFlexRow>
...
We can define the type method using the following Go syntax:
...
<a href="https://ikehakinyemi.pieces.cloud/?p=b93243aa67" target="_blank" rel="noopener noreferrer">Save this code</a>
