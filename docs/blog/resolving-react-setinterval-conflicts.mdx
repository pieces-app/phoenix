---
title: React SetInterval Conflicts | How to Easily Resolve Them
description: Have you ever noticed React setInterval functions acting strangely? I’ve found that React Hooks can often help to fix setInterval problems.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/resolving-react-setinterval-conflicts" />
...
```
Output:
![](https://uploads-ssl.webflow.com/6143afec68f555387049efb3/6143afec68f555387049efb3/63878e41c47f5726807b7e2a_image7_500c7375fc04ff89348244a79c76c3bb_800.png)
...
Make sure to test this out for yourself to see how it performs. All I ask is that you start using this in your React project so that you discover its value.
