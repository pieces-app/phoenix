...
description: As you know, HTML (HyperText Markup Language) is the essential building block of the web. All web applications use HTML to create structured documents for web pages. HTML indicates texts, images, and other contents on a web page using unique tags.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/getting-started-with-semantic-html" />
