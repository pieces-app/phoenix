...
### Tabnine
<a href="https://tabnine.com" target="_blank">Tabnine</a> is your personal AI code assistant, here to boost your productivity with every line of code you write. The tool suggests tailor-made code completions in whatever language you choose for your project and for whatever IDE you prefer.
...
- <a href="https://marketplace.visualstudio.com/items?itemName=ChakrounAnas.turbo-console-log" target="_blank">Turbo Console Log</a>allows for easier debugging using ```console.log```
