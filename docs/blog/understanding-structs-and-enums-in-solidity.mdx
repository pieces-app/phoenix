---
title: Understanding Structs and Enums in Solidity
description: Structs allow you to create custom data types in Solidity. A variable declared to be a struct can have multiple data types in it. Enums (Enumerables) are user-defined data types that restrict a variable to have only one predefined value from a set of multiple predefined values.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/understanding-structs-and-enums-in-solidity" />
...
<GridFlexRow><Tag>structs</Tag> <Tag>enums</Tag></GridFlexRow>
