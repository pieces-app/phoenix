---
title: How to write, test and deploy Ethereum smart contracts using Truffle
description: Ethereum is a public blockchain that serves as the foundation for creating decentralized, permissions-less, censorship-resistant apps and organizations. To develop these apps (DApps), Ethereum allows developers to write and deploy smart contracts on the Ethereum network.
---

<link rel="canonical" href="https://code.pieces.app/blog/how-to-write-test-and-deploy-ethereum-smart-contracts-using-truffle" />
...
<GridFlexRow><Tag>ethereum</Tag> <Tag>truffle</Tag></GridFlexRow>
