---
title: Remult, TypeScript, and React | The Perfect Combo for a Full-stack App
description: A full-stack application is made up of frameworks, libraries, and tools for developing two separate domain applications - the backend and the frontend. Building these two applications can be very hectic, especially if the frameworks are developed from different programming languages or if one developer is working on both sides of the application.
---
...
<link rel="canonical" href="https://code.pieces.app/blog/remult-typescript-react-fullstack-app" />
...
<GridFlexRow><Tag>react</Tag> <Tag>remult</Tag></GridFlexRow>
