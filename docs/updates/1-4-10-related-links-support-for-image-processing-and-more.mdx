---
title: 1.4.10 | Related Links, Support for Image Processing and more
description: The headliners in this release include Related Links - when saving a code snippet, context is critical. Also check out our Image Processing - Pieces OS now contains all the infrastructure needed to store and process images, including screenshots. User-facing upgrades will be out in a couple of weeks.
---
...
<link rel="canonical" href="https://code.pieces.app/updates/1-4-10-related-links-support-for-image-processing-and-more" />
