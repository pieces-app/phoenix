---
title: Pieces 1.8.0 | It’s getting pretty wild out here 🤠 Automatic Snippet Descriptions, JSON/YAML/TOML support, Gen 2 Sharing, and a whole lot more 🔥
description: Today, we’re releasing a seriously upgraded sharing experience, support for JSON, YAML and TOML (a very popular request!), the ability to copy code with its context in the Pieces desktop app and so much more!
---
...
<link rel="canonical" href="https://code.pieces.app/updates/pieces-1-8-0-automatic-snippet-descriptions-json-yaml-toml-support-gen2-sharing" />
