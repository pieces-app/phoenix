---
title: Pieces Desktop App 1.10.2 and Pieces OS 3.1.1: Workflow Activity - Now with Top-Level Metadata 🔥, Preview Before Paste 🫣 & Snippet Indent Clean-up ➡️
description: The Pieces team is kicking off the New Year with a bang! Less than one week into 2023, we’re already rolling out releases focused on supercharging developer productivity. To date, we have been hard at work enabling our users to easily save, search, share and reuse Code Snippets and other helpful materials from their developer workflow. As the team moves into Q1 you’ll see us not only refining our top feature set; but further, layering in complimentary workflow experiences that have big benefits to your work-in-progress productivity as a whole.
---
...
<link rel="canonical" href="https://code.pieces.app/updates/pieces-desktop-app-1102-and-pieces-os-311-workflow-activity-now-with-top-level-metadata-preview-before-paste-snippet-indent-clean-up" />
